                    ...
                    <c:when test = "${not empty login.login}">
                        ...
                        <c:when test = "${formType == 1}">
                            <div class="container">
                                ...
                                <form action="tipos?action=new" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="tipos" class="btn btn-block btn-danger">Cancelar</a>
                                    </div>
                                    <div class="col-md-6">
                           ...
                           <c:otherwise>
                               <div class="container">
                                ...
                                <form action="tipos?action=update" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">                    
                                        <div class="form-group">
                                            <label>Nome:</label><br>
                                            <input class="form-control" type="text" name="nome" placeholder="Nome" value="<c:out value='${tipo.nome}' />" required>
                                            <input type="hidden" name="id" value="<c:out value='${tipo.id}' />">
                                        </div>
                                    </div>

    ...
    <script>
            function myFunction(x) {
                ...
                if (r == true) {
                    ...
                    link.setAttribute('href', "planos?action=remove&id="+x);
                } else {
                    return false;
                } 
            }
    ...
    <body>
        ...
        <jsp:useBean id="login" scope="session" class="br.ufpr.tads.dac.beans.AdministradorBean" />
			...
			<div class="container-fluid">
                            ...
                            <a href="planos?action=formNew" class="btn btn-success"> Adicionar </a> 
                            ...
                            <table class="table table-hover">
                                ...
                                <th> </th>
                                    ...
                                    <td><a href="planos?action=formUpdate&id=${x.id}"><i class="fa fa-pencil-square"> </i></a></td>
